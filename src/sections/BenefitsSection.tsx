...
export const BenefitsSection: React.FC = () => (
  <section id="beneficios" className="relative bg-[#06070a] border-b border-white/10 overflow-hidden">
    <div className="absolute inset-0 bg-led-grid opacity-20" aria-hidden="true" />
          ...
          >
            <div className="flex items-start gap-5">
              <div className="shrink-0">
                ...
                <span className="block mt-3 text-[10px] font-black tracking-[0.25em] text-[#51545e] text-center">{number}</span>
              </div>
              <div>
                <h3 className="text-xl lg:text-2xl font-black uppercase tracking-tight text-white">{title}</h3>
                <span className="block w-10 h-[3px] bg-[#ff143f] my-4 shadow-[0_0_12px_#f8032d]" />
                <p className="text-sm text-[#aeb0b8] leading-relaxed max-w-sm">{text}</p>
              </div>
            </div>
          </article>
        ))}
